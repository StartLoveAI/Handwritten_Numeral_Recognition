...
class Network(object):
    ...
    def sgd(self, train_data, test_data):
        ...
        for j in range(self.epochs):
            ...
            mini_batches = [train_data[k:(k + self.mini_batch_size)] for k in range(0, n,
...
if __name__ == '__main__':
    ...
    train_data_set = list(zip(mnist.train.images, mnist.train.labels))
    test_data_set = list(zip(mnist.test.images, mnist.test.labels))
